...
<body>Successfully
	...
	<div id="body">
		<div class="content">
                    ...
                    <center><h2>Time Seal to Cloud File</h2></center>
                        <!-- start body---->
   <!-- /.container -->
...
<!--                                <th style="text-align: center;width: 100px;">Start Time</th>
                                ...
                                <th style="text-align: center">Time Seal</th>
                            </tr>
                            <tr>
                                <%
                                    Connection con = null;
...
<!--                                        <td><%=rs.getString("start_time")%></td>     
                         ...
                         <td> <a href="set_date.jsp?id=<%=rs.getString("id")%>&fname=<%=rs.getString("filename")%>"><font style="color: green">Click</a></font> </td>
                                        <tr />
                                        <%
