			...
			<h2>Registration</h2>
				...
				<label for="email"> <span>Email*</span>
                                ...
                                <label for="password"> <span>Password</span>
                                    ...
                                    <span><sub>Password (UpperCase, LowerCase, Number/SpecialChar and min 6 Chars)</sub>
                                </label>
				<label for="DateOfBirth"> <span>Date Of Birth</span>
                                ...
                                <label for="State"> <span>Your State</span>
                                    <input type="text" name="state" placeholder="Your State" required="" id="firstName">
				</label>
                                <label for="firstName"> <span>Your Country</span>
                                    <input type="text" name="country" placeholder="Your Country" required="" id="firstName">
				</label>
                            <label for="Role"><span>Role</span>
                                <select name="gender" id="email">
                                 ...
                                 <input type="hidden" value="10" name="status" />
                            </label>
